    ...
    public class Migrations : DataMigration
    {
        ...
        public async Task<int> CreateAsync()
        {
            await _contentDefinitionManager.AlterPartDefinitionAsync(nameof(MyCustomPart), part => part
                .Attachable()
                .WithDescription("A custom part with fields.")
        ...
        public async Task<int> UpdateFrom1Async()
        {
            await _contentDefinitionManager.AlterPartDefinitionAsync(nameof(MyCustomPart), part => part
                .WithField("NewField", field => field
                    .OfType("TextField")
                    .WithDisplayName("New Field (From Update)")
                    .WithSettings(new TextFieldSettings
                    {
                        Hint = "This field was added from UpdateFrom1Async.",
                        Required = false
                    })
                )
            );
